...
# or	\\ad.sfwmd.gov\dfsroot\data\wsd\SUP\proj\CFWI_WetlandStress\Update2018
#==================================================================================================
#==================================================================================================
...
#
#		zetaModels generated by ZetaCalcIntegrals.R are used
...
#		by wetland type (ridge or plain) from stress to unstress and from unstressed to stressed.
#==================================================================================================
  ...
  for (phys in physVec) {
    for (stress in stressVec) {
      oneTest <- thetaEval[thetaEval$'Stress Status in 2018' == stress &
                           ...
                           c('EMT_ID',ranks,'Stress Status in 2018',
...
plot(x ~delta, data=BigZ[BigZ$phys=='Ridge',],pch=20, cex=.5)
...
lines(newdata$delta, newdata$pred1, col='red')
...
lines(newdata$delta, newdata$pred1, col='blue')
...
lines(newdata$delta, newdata$pred1, col='orange')
...
lines(newdata$delta, newdata$pred1, col='green')
...
longPolynom[longPolynom$Category=='ZRPu',]$Category <- 'Ridge Adverse Chg'
...
ggplot(data=longPolynom, aes(x=delta, y=Zeta, color=Category)) + 
  ...
  scale_x_continuous(breaks = c(seq(-15,15,3))) +
